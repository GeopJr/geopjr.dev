---
title: My first in-person talk
subtitle: Linux App Summit 2026
date: 2026-05-31
tags:
    - opinion
    - gnome
...
<figure>
    <img alt="Me on stage speaking on a microphone while there's a projection behind me with the title 'Digging through the app cemetery'" src="{{GEOPJR_BLOG_ASSETS}}/1.webp" loading="lazy" decoding="async" />
    <figcaption>Photo by <a href="https://social.wake.st/@liaizon" rel="noopener noreferrer">Liaizon Wakest</a></figcaption>
</figure>
...
I had an [awesome & interesting talk](https://las25.geopjr.dev/) about Tuba and was getting ready to present it. Unfortunately, due to unforeseen events, I wasn't able to participate in-person. That was my first talk experience.
...
![Monitor showing boarding times and gates at the airport]({{GEOPJR_BLOG_ASSETS}}/3.webp)
...
![pov photo of my knees touching the seat in front of me]({{GEOPJR_BLOG_ASSETS}}/5.webp)
...
![photo of a mall? with windows at the top and tall plants]({{GEOPJR_BLOG_ASSETS}}/6.webp)

![photo of a bear statue. The bear has an earth skin]({{GEOPJR_BLOG_ASSETS}}/7.webp)
...
I also had to prepare my laptop by creating a user account for the presentation and transferring the files over. I do my presentations in [slidev](https://sli.dev/), so the export requires a web server. I really didn't want to bother with setting up node just for this, so I ran it through php. 😰
...
![photo of the airplane window above Berlin]({{GEOPJR_BLOG_ASSETS}}/8.webp)

<figure>
    <img alt="Me on stage speaking on a microphone while there's a projection behind me with the title 'Death is an opportunity'" src="{{GEOPJR_BLOG_ASSETS}}/2.webp" loading="lazy" decoding="async" />
    <figcaption>Photo by <a href="https://social.wake.st/@liaizon" rel="noopener noreferrer">Liaizon Wakest</a></figcaption>
</figure>

And of course, huge thanks to the GNOME Foundation for sponsoring my travel expenses. I wouldn't have been able to participate without them! Consider [donating to GNOME](https://donate.gnome.org/en/).

![Sponsored by the GNOME Foundation badge]({{GEOPJR_BLOG_ASSETS}}/9.webp)
